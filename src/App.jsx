...
function Landing({navTo,customer,user,therapistUser,therapistLogout,custLogout,setCustModal,setModal,therapists,setBD,initBD,resetBdText}){
  ...
  return(
    <div style={{fontFamily:"-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif",paddingTop:62}}>
      ...
      {/* ── FIND US ── */}
      <div style={{background:"#111827",padding:"36px 16px 0"}}>
        <div style={{maxWidth:900,margin:"0 auto"}}>
          <div style={{textAlign:"center",marginBottom:20}}>
            <div style={{fontSize:11,fontWeight:700,color:GOLD,textTransform:"uppercase",letterSpacing:".18em",marginBottom:6}}>Find Us</div>
            <h2 style={{fontFamily:"'Playfair Display',serif",fontSize:24,color:WH,margin:"0 0 4px"}}>Our Location</h2>
            <p style={{color:"rgba(255,255,255,.5)",fontSize:13,margin:0}}>20 Mikocheni Ruvu Street · Dar es Salaam, Tanzania</p>
          </div>
          ...
          <div style={{display:"flex",gap:10,justifyContent:"center",marginBottom:28,flexWrap:"wrap"}}>
            <a href="https://maps.google.com/?q=20+Mikocheni+Ruvu+Street,+Dar+es+Salaam,+Tanzania"
              target="_blank" rel="noopener noreferrer"
              style={{display:"inline-flex",alignItems:"center",gap:8,padding:"11px 22px",borderRadius:10,
                background:"#4285F4",color:WH,textDecoration:"none",fontSize:14,fontWeight:700,
          ...
          {/* Info row */}
          <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(200px,1fr))",gap:16,paddingBottom:32}}>
            <div style={{textAlign:"center"}}>
              <div style={{fontSize:28,marginBottom:8}}>📍</div>
              <div style={{fontWeight:700,color:WH,fontSize:14,marginBottom:4}}>Address</div>
              <div style={{color:"rgba(255,255,255,.55)",fontSize:13,lineHeight:1.6}}>
                20 Mikocheni Ruvu Street<br/>Mikocheni, Dar es Salaam<br/>Tanzania
              </div>
            </div>
            <div style={{textAlign:"center"}}>
              <div style={{fontSize:28,marginBottom:8}}>📞</div>
              <div style={{fontWeight:700,color:WH,fontSize:14,marginBottom:4}}>Contact</div>
              <a href="tel:+255786203903" style={{color:GOLD,fontSize:14,fontWeight:700,textDecoration:"none",display:"block"}}>+255 786 203 903</a>
              <a href="https://wa.me/255786203903?text=Hello%20MASSAGE%20TZ%2C%20I%20would%20like%20to%20enquire%20about%20your%20location%20and%20services."
                target="_blank" rel="noopener noreferrer"
                style={{display:"inline-flex",alignItems:"center",gap:5,marginTop:8,color:"#25D366",fontSize:12,fontWeight:700,textDecoration:"none"}}>
            ...
            <div style={{textAlign:"center"}}>
              <div style={{fontSize:28,marginBottom:8}}>🕐</div>
              <div style={{fontWeight:700,color:WH,fontSize:14,marginBottom:4}}>Hours</div>
              <div style={{color:"rgba(255,255,255,.55)",fontSize:13,lineHeight:2}}>
                <div style={{color:GOLD,fontWeight:700,fontSize:14}}>Open 24 Hours</div>
                <div>Every day · All week</div>
                <div style={{color:GOLD,fontSize:12,marginTop:4}}>🏠 Outcall available anytime</div>
              </div>
            </div>
          </div>
        </div>
